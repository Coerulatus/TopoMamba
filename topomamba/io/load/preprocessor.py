...
from topomamba.io.load.utils import ensure_serializable, make_hash
...
class Preprocessor(torch_geometric.data.InMemoryDataset):
    ...
    **kwargs: optional
    ...
    def __init__(
        self, data_dir, data_list, transforms, force_reload=False, **kwargs
    ):
        ...
        pre_transform = transforms#self.instantiate_pre_transform(data_dir, transforms_config)
        self.set_processed_data_dir(data_dir)
        super().__init__(
