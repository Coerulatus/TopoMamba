...
from topomamba.io.load.utils import get_complex_connectivity
from topomamba.data.lifting import GraphLifting
...
class SimplicialNeighborhoodLifting(Graph2SimplicialLifting):
    ...
    **kwargs : optional
    ...
    def __init__(self, max_k_simplices=5000, hops=1, **kwargs):
        super().__init__(**kwargs)
